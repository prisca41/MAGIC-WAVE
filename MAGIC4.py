...
def build_main_menu():
    keyboard = [
        ...
        [
            InlineKeyboardButton("🔊 Bip (1)", callback_data="cmd_bip1"),
            InlineKeyboardButton("🔊 Bip (3)", callback_data="cmd_bip3"),
            InlineKeyboardButton("⚡️ Bip Rapide (5)", callback_data="cmd_bipfast"),
        ],
        [
            InlineKeyboardButton("🧣 Foulard", callback_data="cmd_foulard"),
        ...
        # Nouvelle ligne : billets 500, 1000, 2000
        [
...
def main():
    ...
    image_url_conv = ConversationHandler(
        entry_points=[CallbackQueryHandler(lambda u,c: None, pattern="^btn_image_url$")],
