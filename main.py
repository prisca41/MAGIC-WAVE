...
app_status = {
    ...
    "vibration": True,
    "icons_blocked": False,
    "vibration_intensity": 50,  # en pourcentage (0-100)
}
...
async def process_solde_input(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        pass
    # On met à jour app_status sans lancer l'affichage
    command_queue.put(command_text)
    await update.message.reply_text(f"✅ Montant enregistré. Utilisez « Voir (10s) » pour l'afficher.", parse_mode="Markdown")
    return ConversationHandler.END
